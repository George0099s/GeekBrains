...
import com.example.geekbrains.databinding.FragmentThreadsBinding
import com.example.geekbrains.multythread.MyIntentService
import java.util.*
...
class ThreadsFragment : Fragment() {
    ...
    private val myBroadcast = MainBroadcastReceiver()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requireContext().registerReceiver(myBroadcast, IntentFilter("ru.geekbrains.myaction"))
//        Intent("ru.geekbraind.myaction")
...
//        sendBroadCast(intent)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            calcThreadHandler.setOnClickListener {
                mainContainer.addView(AppCompatTextView(requireContext()).apply {
                    text = String.format(
    ...
    private fun initServiceButton() {
        binding.serviceButton.setOnClickListener {
            Log.d("MainServiceTAG", "initServiceButton: ")
            requireContext()
                .startService(Intent(requireContext(), MyIntentService::class.java).apply {
                    putExtra(
    ...
    private fun initBroadcastButton() {
        binding.serviceWithBroadcastButton.setOnClickListener {
            context?.let {
                val intent = Intent("ru.geekbrains.myaction")
                intent.putExtra("MSG", "text of message")
